...
출, 퇴근 시 [그룹웨어 사이트](http://gw.tektonspace.com/){:target="_blank"}에서 하기
...
찬양은 인도자가 한 곡을 선정하고 기도제목은 선한목자교회의 [예수동행기도 사이트](http://www.praywithjesus.org/){:target="_blank"}에서 당일 **매일 합심기도**를 이용합니다.
...
[생명의삶 사이트](http://www.duranno.com/qt/){:target="_blank"}에서 **청장년** 생명의 삶으로 진행합니다.
...
[그룹웨어 사이트](http://gw.tektonspace.com/){:target="_blank"}에서 신청
...
개인컵: 같은 종류로 여러개 있는 컵이 아니라면 보통 개인컵.
